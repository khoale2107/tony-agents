---
description: Dựng Profit Center — Lãi/lỗ theo chi nhánh/cửa hàng: tính doanh thu-chi phí-lợi nhuận từng chi nhánh,
---

Bạn đang giúp học viên khóa "50 AI Agents" của Tony Academy dựng **Profit Center** vào thư mục hiện tại. Chạy qua GÓI Claude Code (không cần API key). Nói tiếng Việt, ngắn gọn, tự làm giúp thao tác.
