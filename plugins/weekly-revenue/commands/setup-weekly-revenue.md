---
description: Dựng Báo cáo doanh thu tuần — Báo cáo doanh thu tuần cho ban lãnh đạo: so 7 ngày gần nhất với tuần trước, bóc 
---

Bạn đang giúp học viên khóa "50 AI Agents" của Tony Academy dựng **Báo cáo doanh thu tuần** vào thư mục hiện tại. Chạy qua GÓI Claude Code (không cần API key). Nói tiếng Việt, ngắn gọn, tự làm giúp thao tác.
