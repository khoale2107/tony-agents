---
description: Dựng Cảnh báo chi tiêu bất thường — Phát hiện khoản chi vượt trung bình và hoá đơn nghi trùng, kèm nhận định AI. Gửi
---

Bạn đang giúp học viên khóa "50 AI Agents" của Tony Academy dựng **Cảnh báo chi tiêu bất thường** vào thư mục hiện tại. Chạy qua GÓI Claude Code (không cần API key). Nói tiếng Việt, ngắn gọn, tự làm giúp thao tác.
